    ...
    >
      ...
      >
        <>
          ...
          <aside
            className={`app-sidebar flex h-full w-64 max-w-[min(16rem,88vw)] flex-shrink-0 flex-col ${sidebarClassName} ${
          ...
          >
            <div className={`border-b px-4 py-4 ${themeClasses.border}`}>
                ...
                {(user.role === UserRole.SITE_ENGINEER
                  ...
                  if (user.role !== UserRole.SITE_ENGINEER) {
                    if (item.id === 'financial_management') {
                      ...
                      if (!isTeamLead && !isSpecialUser) return null;
                  ...
                  return (
                    <button
                      ...
                      className={`sidebar-nav-item w-full flex items-center gap-3 rounded-xl px-3 py-2.5 text-left ${getTourClassName(item.id)} ${getNavItemClassName(isActive)} ${
                        isActive ? '' : 'sidebar-nav-enter'
                      }`}
                    >
                      ...
                      <span
                        className={`truncate text-sm transition-transform duration-200 ${
              ...
              <div className={`mt-auto border-t ${themeClasses.border}`}>
                <div className="p-3">
                  <div
                    className={`profile-menu sidebar-profile-card group flex items-center gap-2.5 rounded-xl px-2.5 py-2 ${themeClasses.glassCard} ${themeClasses.border} ${
            ...
            <div className="flex min-w-0 flex-1 items-center gap-2 sm:gap-3">
              ...
              {!hideSidebar && (
                <button
                  ...
                  className={`flex md:hidden items-center justify-center h-9 w-9 shrink-0 rounded-xl border transition-all ${themeClasses.buttonSecondary} ${themeClasses.border} ${
                    sidebarOverlayOpen ? (isDarkTheme ? 'bg-white/10' : 'bg-slate-100') : ''
                  }`}
              ...
              {hideSidebar && (
                <button
                  type="button"
                  onClick={toggleSidebarOverlay}
                  className={`flex items-center justify-center gap-2 h-9 min-w-9 px-3 border rounded-xl text-xs font-bold transition-all shrink-0 ${themeClasses.buttonSecondary} ${themeClasses.border} ${
                    sidebarOverlayOpen ? (isDarkTheme ? 'bg-white/10' : 'bg-slate-100') : ''
                  }`}
                  title={sidebarOverlayOpen ? 'Close menu' : 'Open menu'}
                  aria-label={sidebarOverlayOpen ? 'Close menu' : 'Open menu'}
              ...
              {activeTab === "team_projects" &&
                ...
                <div className="relative min-w-0 shrink">
                  <button
                    ...
                    className={`flex items-center gap-2 h-9 px-3 border rounded-xl transition-all ${
                      isDarkTheme
                  ...
                  {isProjectDropdownOpen && (
                    <>
                      ...
                      />
                      <div
                        className={`absolute top-full left-0 mt-2 w-64 rounded-2xl shadow-2xl z-50 overflow-hidden border animate-in fade-in slide-in-from-top-2 ${
                          isDarkTheme
            ...
            <div className="relative z-[110] flex items-center gap-4">
              {user.role === UserRole.TEAM_LEAD && (
                <button
                  ...
                  className={`team-leader-tour-btn inline-flex items-center gap-1.5 rounded-xl border px-3 py-2 text-xs font-bold transition-colors disabled:cursor-not-allowed disabled:opacity-50 ${
                    isDarkTheme
              ...
              <button
                ...
                className={`relative flex h-9 w-9 items-center justify-center rounded-xl transition-colors ${themeClasses.buttonSecondary}`}
                aria-label="Notifications"
              >
                <Icons.Notification size={18} />
                {unreadCount > 0 && (
                  <span
                    className={`absolute right-1 top-1 flex h-4 w-4 items-center justify-center rounded-full border-2 bg-rose-500 text-[8px] font-black text-white ${
              ...
              {showNotifications && (
                <div
                  className={`absolute top-full right-0 mt-2 w-80 rounded-2xl z-50 animate-in fade-in slide-in-from-top-2 ${
                    isDarkTheme
                      ? "glass-card"
                      ...
                      userNotifications.map((n) => (
                        <div
                          ...
                          onClick={() => {
                            ...
                            if (n.projectId) setActiveTab("dpr_records");
                          }}
                        ...
                        >
                          <div className="flex gap-3">
                            ...
                            <div>
                              ...
                              <p
                                className={`text-[10px] mt-1 leading-normal font-medium ${
                                  isDarkTheme ? "muted" : "text-gray-600"
                                }`}
                              >
                                {n.message}
                              ...
                              <p
                                className={`text-[8px] mt-2 font-bold uppercase tracking-tight ${
                          ...
                          {!n.isRead && (
                            <div
                              className={`absolute right-4 top-4 w-1.5 h-1.5 rounded-full ${
