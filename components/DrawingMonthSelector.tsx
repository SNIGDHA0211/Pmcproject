...
import { MONTH_OPTIONS, buildDrawingYearOptions } from '../utils/drawingSummary';

import { getThemeClasses, useTheme } from '../utils/theme';



interface DrawingMonthSelectorProps {
...
const DrawingMonthSelector: React.FC<DrawingMonthSelectorProps> = ({
  ...
  yearOptions = buildDrawingYearOptions(),
...
export default React.memo(DrawingMonthSelector);
